...
async function handleSearchSubmit(ev) {
  ev.preventDefault();
  let search = ev.target.querySelector("input");

  keyword = search.value;
  showHideWelcomeSearch();
...
function showHideWelcomeSearch() {
  if (keyword === "") {
    document.getElementById("welcome").classList.remove("inactive");
    document.getElementById("search-results").classList.add("inactive");
  } else {
